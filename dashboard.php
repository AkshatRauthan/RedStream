...
$donations_count = 0;
if ($conn->query("SELECT COUNT(*) as total FROM donation_history WHERE donor_email = '$email'")) {
    $result = $conn->query("SELECT COUNT(*) as total FROM donation_history WHERE donor_email = '$email'");
